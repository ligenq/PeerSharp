...
public sealed class TestCoverageTests
{
    ...
    {
        "PeerSharp.BEncoding.BDict",
        "PeerSharp.BEncoding.BList",
        "PeerSharp.BEncoding.BNumber",
        "PeerSharp.BEncoding.BString",
        "PeerSharp.BEncoding.BencodeParser",
        "PeerSharp.BEncoding.BencodeResult",
        "PeerSharp.BEncoding.BencodeWriter",
        "PeerSharp.BEncoding.PooledBufferWriter",
        "PeerSharp.Clients.ClientEngineFactory",
        "PeerSharp.Config.AlertSettings",
        "PeerSharp.Config.FilesSettings",
        "PeerSharp.Config.TorrentClientOptions",
        "PeerSharp.Config.TransferSettings",
        "PeerSharp.Core.AtomicDisposal",
        "PeerSharp.Core.DhtIndexerOptions",
        "PeerSharp.Core.TorrentFileEntry",
        "PeerSharp.Interfaces.DownloadProgress",
        "PeerSharp.Interfaces.PieceProgress",
        "PeerSharp.Internals.Dht.Bep46Resolver",
        "PeerSharp.Internals.Dht.DhtExternalIpVoteResult",
        "PeerSharp.Internals.Dht.DhtImmutableItem",
        "PeerSharp.Internals.Dht.DhtItem",
        "PeerSharp.Internals.Dht.DhtMutableItem",
        "PeerSharp.Internals.Dht.DhtTarget",
        "PeerSharp.Internals.Framework.Defect",
        "PeerSharp.Internals.Framework.TcpListenerAdapter",
        "PeerSharp.Internals.Framework.UdpSocketAdapter",
        "PeerSharp.Internals.Framework.UdpSocketFactory",
        "PeerSharp.Internals.LifetimeByteTotals",
        "PeerSharp.Internals.MerkleHashRequestSelection`1",
        "PeerSharp.Internals.Network.PortMapperFactory",
        "PeerSharp.Internals.Network.SystemDnsResolver",
        "PeerSharp.Internals.NullAlertsManager",
        "PeerSharp.Internals.Peers.MessageQueue",
        "PeerSharp.Internals.Peers.PeerCommunicationFactory",
        "PeerSharp.Internals.Peers.PrefixedStream",
        "PeerSharp.Internals.Peers.ProtocolEncryptionHandshake",
        "PeerSharp.Internals.ProtocolConstants",
        "PeerSharp.Internals.TorrentServices",
        "PeerSharp.Internals.TorrentWebSeeds",
        "PeerSharp.Internals.Trackers.TrackerBase",
        "PeerSharp.Internals.Transfers.EndGameBlockRequestStrategy",
        "PeerSharp.Internals.Transfers.PeerRequestCollection",
        "PeerSharp.Internals.Transfers.PieceVerificationOutcome",
        "PeerSharp.Internals.Transfers.RequestCompletionTracker",
        "PeerSharp.Internals.Transfers.RequestQueuePolicy",
        "PeerSharp.Internals.Transfers.StandardBlockRequestStrategy",
        "PeerSharp.Internals.Transfers.TransferProgressReporter",
        "PeerSharp.Internals.Transfers.UploadQueueItem",
        "PeerSharp.Internals.Utilities.DiffieHellman",
        "PeerSharp.Internals.Utilities.NatPmpPortMapping",
        "PeerSharp.Internals.Utilities.RC4",
        ...
        "PeerSharp.Streaming.HttpListenerStreamRequest",
        "PeerSharp.Streaming.HttpListenerStreamResponse",
        "PeerSharp.Streaming.HttpRangeParser",
        "PeerSharp.Streaming.HttpStreamMimeTypes",
    ...
    {
        "PeerSharp.BEncoding.BencodeResult.get_Span",
        "PeerSharp.BEncoding.PooledBufferWriter.Advance",
        "PeerSharp.BEncoding.PooledBufferWriter.GetMemory",
        "PeerSharp.BEncoding.PooledBufferWriter.GetSpan",
        ...
        "PeerSharp.Internals.Dht.DhtTarget.get_IsEmpty",
        "PeerSharp.Internals.Dht.DhtTarget.get_Memory",
        ...
        "PeerSharp.Streaming.HttpListenerStreamResponse.get_ContentLength",
        "PeerSharp.Streaming.HttpListenerStreamResponse.get_ContentType",
        "PeerSharp.Streaming.HttpListenerStreamResponse.get_ProtocolVersion",
        "PeerSharp.Streaming.HttpListenerStreamResponse.get_StatusCode",
